...
public class FinishedQuizResponseAdapter extends RecyclerView.Adapter<FinishedQuizResponseAdapter.QuizResponseViewHolder> {

    private List<QuizResponse> responseList;
    private Context context;

    public FinishedQuizResponseAdapter(Context context, List<QuizResponse> responseList) {
